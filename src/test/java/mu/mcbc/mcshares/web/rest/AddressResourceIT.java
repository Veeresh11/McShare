...
import mu.mcbc.mcshares.domain.Address;
import mu.mcbc.mcshares.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    private static final String DEFAULT_ADRESS_1 = "AAAAAAAAAA";
    private static final String UPDATED_ADRESS_1 = "BBBBBBBBBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().adress1(DEFAULT_ADRESS_1).address2(DEFAULT_ADDRESS_2).town(DEFAULT_TOWN).country(DEFAULT_COUNTRY);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().adress1(UPDATED_ADRESS_1).address2(UPDATED_ADDRESS_2).town(UPDATED_TOWN).country(UPDATED_COUNTRY);
        return address;
    }
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getAdress1()).isEqualTo(DEFAULT_ADRESS_1);
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].adress1").value(hasItem(DEFAULT_ADRESS_1)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.adress1").value(DEFAULT_ADRESS_1))
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.adress1(UPDATED_ADRESS_1).address2(UPDATED_ADDRESS_2).town(UPDATED_TOWN).country(UPDATED_COUNTRY);
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getAdress1()).isEqualTo(UPDATED_ADRESS_1);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.adress1(UPDATED_ADRESS_1).town(UPDATED_TOWN).country(UPDATED_COUNTRY);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.adress1(UPDATED_ADRESS_1).address2(UPDATED_ADDRESS_2).town(UPDATED_TOWN).country(UPDATED_COUNTRY);
